...
- When done properly, the final object should look something like this (there are only 3 children each in this image):
  ...
  ![wallet-object](Screenshots/wallet-addresses1.png)
  ![wallet-object](Screenshots/wallet-addresses2.png)
...
- You'll need to set the account with  `priv_key_to_account` and use `send_tx` to send transactions.
  ...
  - **Bitcoin Testnet transaction**
    ...
    - Screenshot the confirmation of the transaction like so:
      ...
      ![btc-test](Screenshots/btc-test-tx.png)
  ...
  - **Local PoA Ethereum transaction**
    ...
    - Send a transaction from the pre-funded address within the wallet to another, then copy the `txid` into
      MyCrypto's TX Status, and screenshot the successful transcations.
      
- NO BALANCE IN MY PRE-FUNDED ACCOUNTS, THIS APPEARS TO BE A CONTINUATION OF THE ISSUES THAT I WAS EXPERIENCING WITH THE POA DEVELOPMENT CHAIN POJECT. I SUCCESSFULLY CREATED THE NODEX AND CONNECTED TO MY LOCAL BLOCKCHAIN HOWEVER BECUAE BY ACCOUNT BALANCE IN ZERO I AM UNABLE TO MAKE ANY TRANSACTIONS 
